...
class SetXpTask extends MySQLTask {
	...
	public function onRun() {
		...
		// Do the query
		$mysqli->query("UPDATE kingdomscraft_economy SET xp = GREATEST({$this->amount}, 0) WHERE username = '{$mysqli->escape_string($this->name)}'");
